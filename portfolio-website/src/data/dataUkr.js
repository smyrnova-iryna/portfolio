    ...
    mainSection: {
        ...
        experience: {
            ...
            job: {
                ...
                description: `Відповідаю за розробку корпоративного вебсайту компанії (за напрямком "Виробництво і продаж деревообробних верстатів").`, 
                date: "02.2023 - до сьогодні"
            },
            volunteering: {
                title: "Волонтерство",
                subTitle: "HTML/CSS менторка у CodeClub",
                description: `В якості ментора-волонтера у благодійній організації "Благодійний Фонд "Покоління.ЮЕЙ"" відповідала за викладання курсу HTML/CSS студентам вікової групи 12-15 років, що включало підготовку та проведення лекцій, підготовку та перевірку домашніх завдань.`,
